package top.niunaijun.varuna_dumper.utils.provider;
...
import top.niunaijun.varuna_dumper.utils.compat.ContentProviderCompat;
...
public class ProviderCall {
    public static Bundle callSafely(String authority, String methodName, String arg, Bundle bundle) {
        try {
            return call(authority, VarunaDumperCore.get().getContext(), methodName, arg, bundle, 5);
