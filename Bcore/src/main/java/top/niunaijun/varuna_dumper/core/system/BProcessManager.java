...
import top.niunaijun.varuna_dumper.utils.compat.ApplicationThreadCompat;
...
public class BProcessManager {
    ...
    public ProcessRecord startProcessLocked(String packageName, String processName, int userId, int bpid, int callingUid, int callingPid) {
        ...
        synchronized (mProcessLock) {
            ...
            if (!initAppProcessL(app)) {
                ...
                app.pid = getPid(VarunaDumperCore.getContext(), ProxyManifest.getProcessName(app.bpid));
            }
        }
        return app;
    }
    ...
    private int getUsingBPidL() {
        ActivityManager manager = (ActivityManager) VarunaDumperCore.getContext().getSystemService(Context.ACTIVITY_SERVICE);
    ...
    public void restartAppProcess(String packageName, String processName, int userId) {
        synchronized (mProcessLock) {
            ...
            if (app == null) {
                String stubProcessName = getProcessName(VarunaDumperCore.getContext(), callingPid);
    ...
    private int parseBPid(String stubProcessName) {
        ...
        if (stubProcessName == null) {
            ...
            prefix = VarunaDumperCore.getHostPkg() + ":p";
        }
