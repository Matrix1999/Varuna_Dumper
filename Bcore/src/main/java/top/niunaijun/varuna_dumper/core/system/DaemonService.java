...
public class DaemonService extends Service {
    ...
    private void showNotification() {
        NotificationCompat.Builder builder = new NotificationCompat.Builder(getApplicationContext(), getPackageName() + ".varuna_dumper")
    ...
    private void initNotificationManager() {
        ...
        String CHANNEL_ONE_ID = getPackageName() + ".varuna_dumper";
        String CHANNEL_ONE_NAME = "varuna_dumper";
        if (BuildCompat.isOreo()) {
