package top.niunaijun.varuna_dumper.core.system.am;
...
import top.niunaijun.varuna_dumper.utils.ComponentUtils;
import top.niunaijun.varuna_dumper.proxy.record.ProxyActivityRecord;
import top.niunaijun.varuna_dumper.core.system.ProcessRecord;
...
public class ActivityStack {
    ...
    public ActivityStack() {
        mAms = (ActivityManager) VarunaDumperCore.getContext().getSystemService(Context.ACTIVITY_SERVICE);
    }
    ...
    private int startActivityInNewTaskLocked(int userId, Intent intent, ActivityInfo
        ...
        VarunaDumperCore.getContext().startActivity(shadow);
        return 0;
    }
    ...
    private int realStartActivityLocked(IInterface appThread, Intent intent, String
        ...
        args[index++] = VarunaDumperCore.getHostPkg();
        args[index++] = intent;
    ...
    private Intent getStartStubActivityIntentInner(Intent intent, int vpid,
        ...
        shadow.setComponent(new ComponentName(VarunaDumperCore.getHostPkg(), ProxyManifest.getProxyActivity(vpid)));
