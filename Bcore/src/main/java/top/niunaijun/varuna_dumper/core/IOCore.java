...
public class IOCore {
    ...
    public void enableRedirect(Context context) {
        ...
        try {
            ApplicationInfo packageInfo = VarunaDumperCore.getBPackageManager().getApplicationInfo(packageName, PackageManager.GET_META_DATA, BActivityThread.getUserId());
            ...
            if (VarunaDumperCore.getContext().getExternalCacheDir() != null && context.getExternalCacheDir() != null) {
