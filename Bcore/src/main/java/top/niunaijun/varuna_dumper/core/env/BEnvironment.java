package top.niunaijun.varuna_dumper.core.env;
...
public class BEnvironment {
    private static final File sVirtualRoot = new File(VarunaDumperCore.getContext().getCacheDir().getParent(), "virtual");
    private static final File sExternalVirtualRoot = VarunaDumperCore.getContext().getExternalFilesDir("virtual");
