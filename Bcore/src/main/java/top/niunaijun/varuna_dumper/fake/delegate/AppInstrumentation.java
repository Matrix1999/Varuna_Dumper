package top.niunaijun.varuna_dumper.fake.delegate;
...
import top.niunaijun.varuna_dumper.fake.hook.IInjectHook;
import top.niunaijun.varuna_dumper.utils.FileUtils;
import top.niunaijun.varuna_dumper.utils.compat.ContextCompat;
...
public final class AppInstrumentation extends BaseInstrumentationDelegate implements IInjectHook {
    ...
    public void injectHook() {
        try {
            ...
            ActivityThread.mInstrumentation.set(VarunaDumperCore.mainThread(), this);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private Instrumentation getCurrInstrumentation() {
        Object currentActivityThread = VarunaDumperCore.mainThread();
    ...
    public Application newApplication(ClassLoader cl, String className, Context context) throws InstantiationException, IllegalAccessException, ClassNotFoundException {
        ...
        if (VarunaDumperCore.get().isEnableHookDump()) {
            String absolutePath = new File(VarunaDumperCore.get().getDexDumpDir(), context.getPackageName()).getAbsolutePath();
