...
import top.niunaijun.varuna_dumper.fake.service.provider.ContentProviderStub;
import top.niunaijun.varuna_dumper.fake.service.provider.SettingsProviderStub;
...
public class ContentProviderDelegate {
    ...
    public static void update(Object holder, String auth) {
        ...
        switch (auth) {
            case "settings":
                vContentProvider = new SettingsProviderStub().wrapper(iInterface, VarunaDumperCore.getHostPkg());
                break;
            default:
                vContentProvider = new ContentProviderStub().wrapper(iInterface, VarunaDumperCore.getHostPkg());
                break;
        }
        if (BuildCompat.isOreo()) {
    ...
    public static void init() {
        ...
        VarunaDumperCore.getContext().getContentResolver().call(Uri.parse("content://settings"), "", null, null);
    }
