...
import top.niunaijun.varuna_dumper.core.system.pm.IBPackageManagerService;
...
public class BPackageManager {
    ...
    public Intent getLaunchIntentForPackage(String packageName, int userId) {
        ...
        List<ResolveInfo> ris = queryIntentActivities(intentToResolve,
                0,
                intentToResolve.resolveTypeIfNeeded(VarunaDumperCore.getContext().getContentResolver()),
                userId);
    ...
    private IBPackageManagerService getService() {
        ...
        mService = IBPackageManagerService.Stub.asInterface(VarunaDumperCore.get().getService(ServiceManager.PACKAGE_MANAGER));
        return getService();
    }
}
