...
import top.niunaijun.varuna_dumper.core.system.dump.IBDumpManagerService;
...
public class BDumpManager {
    ...
    private IBDumpManagerService getService() {
        ...
        mService = IBDumpManagerService.Stub.asInterface(VarunaDumperCore.get().getService(ServiceManager.DUMP_MANAGER));
        return getService();
    }
}
