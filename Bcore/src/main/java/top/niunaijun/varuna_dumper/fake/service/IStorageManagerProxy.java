...
public class IStorageManagerProxy extends BinderInvocationStub {
    ...
    public static class GetVolumeList extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            if (args == null) {
                StorageVolume[] volumeList = VarunaDumperCore.getBStorageManager().getVolumeList(Process.myUid(), null, 0, BActivityThread.getUserId());
                if (volumeList == null) {
            ...
            try {
                ...
                StorageVolume[] volumeList = VarunaDumperCore.getBStorageManager().getVolumeList(uid, packageName, flags, BActivityThread.getUserId());
                if (volumeList == null) {
                    return method.invoke(who, args);
                }
            } catch (Throwable t) {
