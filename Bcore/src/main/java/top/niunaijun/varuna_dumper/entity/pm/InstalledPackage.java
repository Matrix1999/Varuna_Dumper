package top.niunaijun.varuna_dumper.entity.pm;
...
public class InstalledPackage implements Parcelable {
    ...
    public ApplicationInfo getApplication() {
        return VarunaDumperCore.getBPackageManager().getApplicationInfo(packageName, PackageManager.GET_META_DATA, userId);
    }

    public PackageInfo getPackageInfo() {
        return VarunaDumperCore.getBPackageManager().getPackageInfo(packageName, PackageManager.GET_META_DATA, userId);
    }
