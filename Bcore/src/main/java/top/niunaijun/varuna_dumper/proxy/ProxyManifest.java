package top.niunaijun.varuna_dumper.proxy;
...
public class ProxyManifest {
    ...
    public static String getBindProvider() {
        return VarunaDumperCore.getHostPkg() + ".varuna_dumper.SystemCallProvider";
    }

    public static String getProxyAuthorities(int index) {
        return String.format(Locale.CHINA, "%s.proxy_content_provider_%d", VarunaDumperCore.getHostPkg(), index);
    }

    public static String getProxyActivity(int index) {
        return String.format(Locale.CHINA, "top.niunaijun.varuna_dumper.proxy.ProxyActivity$P%d", index);
    }

    public static String getProxyFileProvider() {
        return VarunaDumperCore.getHostPkg() + ".varuna_dumper.FileProvider";
    }

    public static String getProcessName(int bPid) {
        return VarunaDumperCore.getHostPkg() + ":p" + bPid;
    }
}
